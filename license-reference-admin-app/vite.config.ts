...
export default defineConfig({
  ...
  server: {
    port: 25174,        // below the 32768/49152 ephemeral ranges (Win/Linux/macOS) — avoids the OS-reserved-port bind failure; distinct from the dashboard app's dev port (25173)
