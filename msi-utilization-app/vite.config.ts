...
export default defineConfig({
  ...
  server: {
    port: 25175,        // below the 32768/49152 ephemeral ranges (Win/Linux/macOS) — avoids the OS-reserved-port bind failure; distinct from the dashboard (25173) and admin (25174) dev ports
